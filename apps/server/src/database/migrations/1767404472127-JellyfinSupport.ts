...
export class JellyfinSupport1767404472127 implements MigrationInterface {
  name = 'JellyfinSupport1767404472127';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "idx_collection_media_collection_id"`);
    await queryRunner.query(
      `CREATE TABLE "temporary_collection_media" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "collectionId" integer NOT NULL, "mediaServerId" varchar NOT NULL, "tmdbId" integer, "addDate" datetime NOT NULL, "image_path" varchar, "isManual" boolean DEFAULT (0))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_exclusion" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "mediaServerId" varchar NOT NULL, "ruleGroupId" integer, "parent" integer, "type" integer)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_exclusion"("id", "mediaServerId", "ruleGroupId", "parent", "type") SELECT "id", "mediaServerId", "ruleGroupId", "parent", "type" FROM "exclusion"`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_settings" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "clientId" varchar DEFAULT ('bee020a6-a56d-4274-a800-c1f6b36cf7c3'), "applicationTitle" varchar NOT NULL DEFAULT ('Maintainerr'), "applicationUrl" varchar NOT NULL DEFAULT ('localhost'), "apikey" varchar, "overseerr_url" varchar, "locale" varchar NOT NULL DEFAULT ('en'), "plex_name" varchar, "plex_hostname" varchar, "plex_port" integer DEFAULT (32400), "plex_ssl" integer, "plex_auth_token" varchar, "overseerr_api_key" varchar, "collection_handler_job_cron" varchar NOT NULL DEFAULT ('0 0-23/12 * * *'), "rules_handler_job_cron" varchar NOT NULL DEFAULT ('0 0-23/8 * * *'), "tautulli_url" varchar, "tautulli_api_key" varchar, "jellyseerr_url" varchar, "jellyseerr_api_key" varchar, "media_server_type" varchar, "jellyfin_url" varchar, "jellyfin_api_key" varchar, "jellyfin_user_id" varchar, "jellyfin_server_name" varchar)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_exclusion" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "mediaServerId" varchar NOT NULL, "ruleGroupId" integer, "parent" integer, "type" varchar)`,
    );
    await queryRunner.query(
      `INSERT INTO "temporary_exclusion"("id", "mediaServerId", "ruleGroupId", "parent", "type") SELECT "id", "mediaServerId", "ruleGroupId", "parent", "type" FROM "exclusion"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "collection_media" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "collectionId" integer NOT NULL, "mediaServerId" varchar NOT NULL, "tmdbId" integer, "addDate" datetime NOT NULL, "image_path" varchar, "isManual" boolean DEFAULT (0))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "exclusion" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "mediaServerId" varchar NOT NULL, "ruleGroupId" integer, "parent" integer, "type" integer)`,
    );
    await queryRunner.query(
      `INSERT INTO "exclusion"("id", "mediaServerId", "ruleGroupId", "parent", "type") SELECT "id", "mediaServerId", "ruleGroupId", "parent", "type" FROM "temporary_exclusion"`,
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "collection_media" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "collectionId" integer NOT NULL, "mediaServerId" varchar NOT NULL, "tmdbId" integer, "addDate" datetime NOT NULL, "image_path" varchar, "isManual" boolean DEFAULT (0), CONSTRAINT "FK_collection_media_collection" FOREIGN KEY ("collectionId") REFERENCES "collection" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
      `INSERT INTO "collection_media"("id", "collectionId", "mediaServerId", "tmdbId", "addDate", "image_path", "isManual") SELECT "id", "collectionId", "mediaServerId", "tmdbId", "addDate", "image_path", "isManual" FROM "temporary_collection_media"`,
    );
